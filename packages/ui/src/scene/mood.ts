...
export const MOOD_STYLE: Record<SphereMood, MoodStyle> = {
  idle: { color: "#22d3ee", spin: 0.05, breathe: 0.9, amp: 0.03, opacity: 0.55, label: "IDLE" },
  thinking: { color: "#38bdf8", spin: 0.18, breathe: 1.8, amp: 0.06, opacity: 0.85, label: "THINKING" },
  executing: { color: "#e879f9", spin: 0.5, breathe: 3.2, amp: 0.09, opacity: 1.0, label: "EXECUTING" },
  awaiting: { color: "#fbbf24", spin: 0.12, breathe: 2.6, amp: 0.05, opacity: 0.9, label: "AWAITING" },
  error: { color: "#ef4444", spin: 0.7, breathe: 6.0, amp: 0.14, opacity: 1.0, label: "ERROR" },
  offline: { color: "#3b4252", spin: 0.02, breathe: 0.5, amp: 0.015, opacity: 0.35, label: "OFFLINE" },
};
